<template>
  <section class="relative pt-20 pb-16 md:pt-24 md:pb-24 overflow-hidden">
    ...
    <div class="absolute inset-0 bg-gradient-to-b from-indigo-900/30 to-game-dark z-0">
      <img src="https://source.unsplash.com/featured/?fantasy,game,adventure" alt="Game background" class="w-full h-full object-cover opacity-50 mix-blend-overlay" />
    </div>
    
    <div class="container relative z-10">
      <div class="flex flex-col items-center text-center">
        <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-6 animate-float">
          <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-pink-400">SW-STATION</span>
        </h1>
        ...
        <div class="mt-12">
          <svg class="animate-bounce w-6 h-6 text-white mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
